...
public class ExampleChaincodeStory {
    ...
    @When("I query installed chaincodes on $peerId")
    public void whenQueryChaincodesOf(String peerId){
        chaincodeAPISteps.queryChaincodeOfPeer(peerId);
    }

    @Then("chaincodes should include $chaincodeName")
    public void thenInstalledChaincodesHas(String chaincodeName){
        chaincodeAPISteps.peerHasInstalled(chaincodeName);
    }
