...
public class UserServiceImpl implements UserService{
    ...
    public UserServiceImpl(@Autowired UserRepo userRepo, @Autowired UserTokenRepo userTokenRepo, @Autowired FabricSDK fabricSDK, @Autowired JwtService jwtService) {
